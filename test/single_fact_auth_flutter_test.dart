...
import 'package:single_fact_auth_flutter/single_fact_auth_flutter_platform_interface.dart';
...
void main() {
  final SingleFactAuthFlutterPlatform initialPlatform = SingleFactAuthFlutterPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    SingleFactAuthFlutter singleFactAuthFlutterPlugin = SingleFactAuthFlutter();
    MockSingleFactAuthFlutterPlatform fakePlatform = MockSingleFactAuthFlutterPlatform();
    SingleFactAuthFlutterPlatform.instance = fakePlatform;

    expect(await singleFactAuthFlutterPlugin.getPlatformVersion(), '42');
  });
}
